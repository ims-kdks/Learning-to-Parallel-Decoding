...
from generate import generate, generate_predict_eot, generate_learn2parallel, generate_l2p_eot, generate_with_prefix_cache, generate_with_dual_cache
...
class LLaDAEvalHarness(LM):
    def __init__(
        ...
        **kwargs,
        ...
        # verify input
        acceptable_methods = ["original", "L2P", "EoT", "L2P+EoT", "L2P+EoT+dual_cache", "L2P+EoT+prefix_cache"]
